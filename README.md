...
![FedSECA-Method](https://github.com/JosephGeoBenjamin/FedSECA-ByzantineTolerance/releases/download/cvpr25-v2W/xFedSECA_method.png)
...
5. The `algorithms` folder has all necessary buildingn blocks. The attacks are in `byznatine_attacks.py` and defenses are in `federation_byz.py`. They are modular enough to include any new methods by creatin new class and including the class name in config file.
...
#### Downloads:
Dataset splits used for training, NoteBooks for plotting and all config files are available in the Downloads of [CVPR2025 releases](https://github.com/JosephGeoBenjamin/FedRISE-ByzantineTolerance/releases/tag/cvpr25-v2W)
