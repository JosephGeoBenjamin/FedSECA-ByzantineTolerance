...
class CountSketchVec(object):
    ...
    def __deepcopy__(self, memodict={}):
        ...
        newCSVec = CountSketchVec(d=self.d, c=self.c, r=self.r,
    ...
    def __iadd__(self, other):
        ...
        """
        if isinstance(other, CountSketchVec):
    ...
    def _findHHK(self, k): #heavy hitter recover by K
    ...
    def _findHHThr(self, thr): #heavy hitter recover by thresh
